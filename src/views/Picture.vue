        ...
        <div class="title">
         ...
         <div class="msg-box">
            ...
            <div class="space-info" v-if="dataFilter(data, keyword) != []">
                ...
                style="width: 100%; box-sizing: border-box; margin: .125rem auto 0; border-radius: .135rem; box-shadow:0px 0px 5px rgba(76,76,76,0.3);"
                max-height="7.3rem"
                height="7.1rem"
                :stripe="true"
                >
...
export default {
    ...
    methods: {
        handleCurrentChange(val) {
            ...
            this.selectPage = val;
            if(this.copyId != "") {
                this.$axios.post(`/picture/selectByIdPage?userId=${this.copyId}&pageindex=${val}&pagesize=${this.pageSize}`)
                    .then(res => {
                        console.log(res);
        ...
        getData() {
            ...
            if(this.search == "") {
                ...
                this.selectPage = 1;
                this.$axios.post(`/picture/selectByIdPage?userId=${this.search}&pageindex=${1}&pagesize=${this.pageSize}`)
                    .then(res => {
                        console.log(res);
                        this.data = res.data.data.list;
